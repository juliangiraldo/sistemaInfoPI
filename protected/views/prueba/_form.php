...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'nombre_prueba'); ?>
		<?php echo $form->textField($model,'nombre_prueba',array('size'=>60,'maxlength'=>100)); ?>
		<?php echo $form->error($model,'nombre_prueba'); ?>
	</div>
