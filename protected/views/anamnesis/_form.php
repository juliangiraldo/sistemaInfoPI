...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'id_tratamiento_actual'); ?>
		<?php echo $form->textField($model,'id_tratamiento_actual'); ?>
		<?php echo $form->error($model,'id_tratamiento_actual'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'referido_por'); ?>
		<?php echo $form->textField($model,'referido_por',array('size'=>60,'maxlength'=>200)); ?>
		<?php echo $form->error($model,'referido_por'); ?>
	</div>
