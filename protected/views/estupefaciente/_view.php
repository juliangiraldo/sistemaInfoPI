...
/* @var $data Estupefaciente */
?>

<div class="view">

	<b><?php echo CHtml::encode($data->getAttributeLabel('id_estupefaciente')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_estupefaciente), array('view', 'id'=>$data->id_estupefaciente)); ?>
	<br />
