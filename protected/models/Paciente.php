...
class Paciente extends ActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'cita' => array(self::HAS_MANY, 'Cita', 'id_paciente'),
			'enfermedades' => array(self::MANY_MANY, 'Enfermedad', 'enfermedades_padres(id_paciente, id_enfermedad)'),
			'estupefacientes' => array(self::MANY_MANY, 'Estupefaciente', 'estupefacientes_padres(id_paciente, id_estupefaciente)'),
			'familiares' => array(self::HAS_MANY, 'Familiar', 'id_paciente'),
			'ocupaciones' => array(self::MANY_MANY, 'Ocupacion', 'paciente_ocupaciones(id_paciente, id_ocupacion)'),
			'idLugarNac' => array(self::BELONGS_TO, 'Ciudad', 'id_lugar_nac'),
