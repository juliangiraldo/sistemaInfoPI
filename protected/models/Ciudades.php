...
/**
 * Esta es la clase de modelo para la tabla "ciudades".
 *
 * Las siguientes son las columnas disponibles en la tabla 'ciudades':
...
class Ciudades extends ActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'Barrios' => array(self::HAS_MANY, 'Barrios', 'id_ciudad'),
