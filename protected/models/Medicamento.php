...
class Medicamento extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_medicamento, descripcion, fecha, creado_por, fecha_creacion, modificado_por, fecha_modificacion, estado', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'anamnesises' => array(self::MANY_MANY, 'Anamnesis', 'medicamentos_anamnesis(id_medicamento, id_anamnesis)'),
		);
	}
